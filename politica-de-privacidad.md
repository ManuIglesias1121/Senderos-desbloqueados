...
### 3.5. Identificador publicitario (solo Plan Free)
- Si usás el **Plan Free** (con publicidad), Google AdMob accede al **Advertising ID** (Android Advertising ID / AAID) de tu dispositivo. Es un identificador alfanumérico **reseteable y desvinculable de tu identidad**, generado por el propio sistema operativo Android.
- Este identificador se utiliza únicamente para mostrarte **anuncios no personalizados** (sin perfilado conductual) y prevenir fraude publicitario. La app está configurada con la opción `requestNonPersonalizedAdsOnly: true`, lo que indica a Google AdMob que **no** debe usar tu historial de navegación, intereses ni otros datos para personalizar los anuncios.
- Podés **resetear** este identificador o **deshabilitarlo** desde *Configuración → Google → Anuncios* de tu dispositivo Android. Si lo deshabilitás, vas a seguir viendo anuncios pero serán completamente genéricos (sin segmentación, ni siquiera contextual).
- En el **Plan Premium** **no se muestran anuncios** y por lo tanto el Advertising ID **no se recolecta ni se transmite a Google**.
...
5. **Mostrar publicidad no personalizada** a los usuarios del Plan Free, a través de Google AdMob (ver sección 3.5 y 7).
6. **Comunicaciones operativas esenciales** vinculadas al uso del servicio (avisos legales, cambios en esta política, soporte).

**No utilizamos tus datos para:**
- Publicidad dirigida con perfilado conductual (los anuncios del Plan Free son **no personalizados**).
...
| **Google LLC** | Procesamiento de pagos in-app en Android (Google Play Billing) y entrega de anuncios no personalizados en el Plan Free (Google AdMob) | Datos financieros del usuario (no nos son transmitidos) · Advertising ID (AAID), modelo/idioma del dispositivo, dirección IP aproximada, datos de interacción con el anuncio (impresión, clic) |
...
- **Google LLC** (con sede en Mountain View, California, EEUU) procesa los pagos in-app en Android y, en el Plan Free, entrega los anuncios no personalizados a través de Google AdMob. Recibe Advertising ID (AAID), datos básicos del dispositivo y de interacción con el anuncio.
...
## 14. Publicidad (solo Plan Free)

El **Plan Free** se financia con publicidad servida por **Google AdMob** (Google LLC). Esta sección detalla cómo funciona y qué podés hacer al respecto.

### 14.1. Qué anuncios mostramos
- Banners adaptables en la pantalla de inicio y en el listado de senderos.
- Los anuncios son **no personalizados**: la app está configurada con `requestNonPersonalizedAdsOnly: true`, lo que indica a AdMob que **no debe** segmentarte con base en tu historial de navegación, intereses ni perfilado conductual. Los anuncios pueden ser contextuales (relacionados con la categoría de la app — outdoor, viajes) pero no se basan en quién sos.

### 14.2. Qué datos recibe Google AdMob
- **Advertising ID (AAID)**: identificador alfanumérico del dispositivo, reseteable y desvinculable de tu identidad.
- **Datos básicos del dispositivo**: modelo, sistema operativo, idioma, zona horaria, dirección IP aproximada.
- **Datos de interacción con el anuncio**: impresión, clic, tiempo de visualización.
- **No** le compartimos tu email, contraseña, ubicación GPS, recorridos, fotos ni ningún otro dato de tu cuenta.

### 14.3. Cómo eliminar los anuncios
Tenés tres alternativas para no ver más publicidad en la app:

1. **Suscribirte al Plan Premium**, que elimina completamente los anuncios.
2. **Resetear o desactivar tu Advertising ID** desde *Configuración → Google → Anuncios* en tu dispositivo Android. Vas a seguir viendo anuncios pero serán genéricos (sin segmentación, ni siquiera contextual).
3. **Combinar ambas**: ser usuario del Plan Premium evita por completo la transmisión del AAID a Google.

### 14.4. Política de Google AdMob
La política de privacidad de Google AdMob, donde se detalla el tratamiento de los datos recolectados con fines publicitarios, está disponible en:
